...
#commoon sequences : list, tuples, , strings, bytes
        ...
        #iterable                                                                              #Everything between the for loop iteration
...
fruit = 'banana'       #banana [1] < you pronounce this as sub 1
letter = fruit [1]     #012345 fruit sub 1 prints out a
print(letter)           #fruit sub [1] is how you pronouce this 
